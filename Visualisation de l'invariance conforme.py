...
plot_conformal_grid(ax2, omega_factor=2.5, title="Métrique Conforme (Échelle x2.5)")
...
plt.suptitle("Démonstration de l'invariance conforme : Expansion de l'échelle et conservation de la géométrie locale",
             fontsize=14)
plt.show()